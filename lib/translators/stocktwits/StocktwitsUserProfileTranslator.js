...
function StocktwitsUserProfileTranslator() {
}

StocktwitsUserProfileTranslator.prototype.getMatchPatterns = function() {
    return [ '^acct:stocktwits:[0-9]+', '/user/[0-9]+' ];
}
StocktwitsUserProfileTranslator.prototype.translate = function( uri, owner, rawDoc, callback ) {
	var userProfile = JSON.parse( rawDoc.data ),
		parseAccountId = uri.match( /acct:stocktwits:[0-9]+/ ),
			...
			try {
				...
				var result = { 
					...
					'appData': { 
						...
						'serviceImgUrl': '/images/512x512-logos/stocktwits.png',
...
module.exports = exports = StocktwitsUserProfileTranslator;
